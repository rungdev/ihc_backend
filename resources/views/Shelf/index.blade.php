            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">ชั้นวางสินค้า
</h4>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card" id="orderList">
                        <div class="card-header border-0">
                            <div class="row align-items-center gy-3">
                                <div class="col-sm">
                                    <h5 class="card-title mb-0">ชั้นวางสินค้า
</h5>
                                </div>
                                <div class="col-sm-auto">
                                    <a href="/shelf/create" class="btn btn-primary btn-add-brand">
                                        <i class="mdi mdi-plus align-middle"></i> เพิ่มชั้นวางสินค้า
                            ...
                            <div class="row border border-dashed border-end-0 border-start-0 mt-3 pb-3 pt-2 ">
                                ...
                                <div class="col-3">
                                    ...
                                    <input type="text" class="form-control" id="searchInp" aria-describedby="basic-addon3" placeholder="ชั้นวางสินค้า
">
                                </div>
                            </div>
                        </div>
                                ...
                                <table 
                                    ...
                                    <thead class="text-muted table-light">
                                        <tr class="text-uppercase">
                                            <th class="" data-width="500" data-field="name_th">ชั้นวางสินค้า</th>
                                            <th class="text-center" data-width="100" data-field="active_status">จำนวนสินค้า</th>
