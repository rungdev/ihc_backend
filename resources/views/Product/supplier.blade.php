                        ...
                        <div class="card-header border-0">
                            <div class="row align-items-center gy-3">
                                ...
                                <div class="col-sm-auto">
                                    <a href="/supplierCreate" class="btn btn-primary btn-add-brand">
                                        <i class="mdi mdi-plus align-middle"></i> เพิ่มผู้ผลิต/จำหน่าย
                                    </a>
                                </div>
                            </div>
                            <div class="row border border-dashed border-end-0 border-start-0 mt-3 pb-3 pt-2 ">
                                ...
                                <div class="col-3">
                                    ...
                                    <input type="text" class="form-control" id="searchInp" aria-describedby="basic-addon3" placeholder="ผู้ผลิต/จำหน่าย">
                                </div>
                            </div>
                        </div>
                                ...
                                <table 
                                    ...
                                    <thead class="text-muted table-light">
                                        <tr class="text-uppercase">
                                            <th class="text-center" data-width="50" data-field="supplier_id">ID</th>
                                            <th class="" data-width="300" data-field="name_th">ชื่อผู้ผลิต/จำหน่าย</th>
                                            <th class="" data-width="300" data-field="contact_name_th">ชื่อผู้ติดต่อ</th>
                                            <th class="" data-width="200" data-field="email">อีเมล</th>
                                            <th class="" data-width="200" data-field="phone">เบอร์โทร</th>
